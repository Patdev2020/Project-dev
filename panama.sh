...
<body>
  ...
  <div class="image-row">
     ...
     <div class="image-card img-red">
      <img src ="https://onlineforlove.com/wp-content/uploads/2020/04/image-283.jpg.webp " alt="Right - Tropical Smile">
     </div>
  </div>
  ...
  <div class="cards">
    ...
    <div class="card">
      ...
      <p><b>Location:</b> <span class="red">Enjoying this class so much</span></p>
      <p><b>Highlight:</b> <span class="yellow">Let's Go Class 7. We got this.</span></p>
      <p><b>Next Lesson:</b> <span class="highlight">SAA certification before the end of the year, people.</span></p>
    </div>
  </div>
</body>
</html>
